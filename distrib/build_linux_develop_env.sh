...
./b2 toolset=gcc cxxflags="-std=c++11 -fPIC" --build-type=minimal --with-chrono --with-date_time --with-system --with-filesystem --with-thread link=static -j8 install
